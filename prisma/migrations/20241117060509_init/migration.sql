/*
  ...
  - The values [spotify] on the enum `LayoutItemType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "LayoutItemType_new" AS ENUM ('text', 'image', 'link', 'section', 'empty', 'html', 'carousel');
